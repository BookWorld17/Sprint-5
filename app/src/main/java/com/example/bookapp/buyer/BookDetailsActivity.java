                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                ...
                                alert.showAAddCartSucess(BookDetailsActivity.this, getString(R.string.success), msg, new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                Intent inte_ = new Intent(BookDetailsActivity.this, BuyerMainActivity.class);
                                                startActivity(inte_);
                                            }
                                        },
                                        new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                Intent inte_ = new Intent(BookDetailsActivity.this, cart.class);
                                                startActivity(inte_);
                                            }
                                        });
                            }else{
