...
public class Order implements Serializable {
    ...
    public void setDeliver_days(String deliver_days) {
        this.deliver_days = deliver_days;
    }

    public String getDeliver_days(Context context) {
        if(deliver_days.equals("0"))
            return context.getString(R.string.not_specified);
        else
            return deliver_days + " days";
    }
    ...
    public String getStatusText(Context context) {
        ...
        {
            statusTxt = "delivered";
        }else if(getOrderStatus().equals("4"))
        {
            statusTxt = "Canceled by user";
        }else if(getOrderStatus().equals("5"))
        {
            statusTxt = "Canceled by seller";
        }
        return statusTxt;
    }
